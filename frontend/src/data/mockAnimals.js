...
export const animals = {
  'africa': [
    ...
    { id: 'af-2', name: 'León', image: 'https://images.unsplash.com/photo-1637494831141-6a6cad57c610?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDk1ODB8MHwxfHNlYXJjaHwxfHxhZnJpY2FuJTIwYW5pbWFsc3xlbnwwfHx8fDE3NjE0ODk5NTJ8MA&ixlib=rb-4.1.0&q=85', sounds: ['lion1.mp3', 'lion2.mp3'] },
    ...
    { id: 'af-8', name: 'Hipopótamo', image: 'https://images.unsplash.com/photo-1581852017103-68ac65514cf7?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2NzZ8MHwxfHNlYXJjaHwyfHxlbGVwaGFudHxlbnwwfHx8fDE3NjE0ODk5ODF8MA&ixlib=rb-4.1.0&q=85', sounds: ['hippo1.mp3', 'hippo2.mp3'] },
    { id: 'af-9', name: 'Suricata', image: 'https://images.unsplash.com/photo-1604336755604-96ee6fa9f3f1?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDk1ODF8MHwxfHNlYXJjaHwyfHxnaXJhZmZlfGVufDB8fHx8MTc2MTQ4OTk4Nnww&ixlib=rb-4.1.0&q=85', sounds: ['meerkat1.mp3', 'meerkat2.mp3'] },
    { id: 'af-10', name: 'Guepardo', image: 'https://images.unsplash.com/photo-1547721064-da6cfb341d50?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDk1ODF8MHwxfHNlYXJjaHwzfHxnaXJhZmZlfGVufDB8fHx8MTc2MTQ4OTk4Nnww&ixlib=rb-4.1.0&q=85', sounds: ['cheetah1.mp3', 'cheetah2.mp3'] },
    { id: 'af-11', name: 'Búfalo', image: 'https://images.pexels.com/photos/1054655/pexels-photo-1054655.jpeg', sounds: ['buffalo1.mp3', 'buffalo2.mp3'] },
    { id: 'af-12', name: 'Gorila', image: 'https://images.unsplash.com/photo-1544211412-2a32426e7fd5?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2NzZ8MHwxfHNlYXJjaHwzfHxlbGVwaGFudHxlbnwwfHx8fDE3NjE0ODk5ODF8MA&ixlib=rb-4.1.0&q=85', sounds: ['gorilla1.mp3', 'gorilla2.mp3'] }
  ],
  'asia': [
